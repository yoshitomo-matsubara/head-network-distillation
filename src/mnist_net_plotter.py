...
def get_argparser():
    ...
    parser.add_argument('-range1', default='5:55:15', help='parameter range for 1st convolution layer')
    parser.add_argument('-range2', default='10:80:20', help='parameter range for 2nd convolution layer')
    return parser
